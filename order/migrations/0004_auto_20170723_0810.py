# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-23 08:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('odate', models.DateTimeField(auto_now=True, verbose_name='order date')),
            ],
        ),
        migrations.CreateModel(
            name='UserProfile',
        ...
        migrations.AddField(
            model_name='product',
            name='img',
            field=models.ImageField(default=1, upload_to='product', verbose_name='img'),
